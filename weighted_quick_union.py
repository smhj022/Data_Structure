...
# Find: takes time propositional to depth of p and q that is num_1 and num_2
# Union: takes constant time for the given root.

# Proposition: Depth of any node x is at most lg N. lg -> log with base 2

#  if N is 10 then depth of any node is at most depth(N) = 3 <= lg(10)

# Proof: When does the depth x (in T1 tree) increases?

# depth is increases when we perform union operation and size of tree T2 is greater than and equal to
# size of T1

# The size of tree is at least doubles since |T2| >= |T1|.
# So the size of tree containing x can double at most lg N times.

# Time complexity of the problem


# N for Initialization method
# lg N for union method
# lg N for connected method
